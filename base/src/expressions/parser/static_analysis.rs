...
fn get_function_args_signature(kind: &Function, arg_count: usize) -> Vec<Signature> {
    match kind {
        ...
        Function::ModeSingl => vec![Signature::Vector; arg_count],
        Function::PercentileInc => vec![Signature::Vector, Signature::Scalar],
        ...
        Function::PercentileExc => vec![Signature::Vector, Signature::Scalar],
        Function::QuartileExc => vec![Signature::Vector, Signature::Scalar],
...
fn static_analysis_on_function(kind: &Function, args: &[Node]) -> StaticResult {
    match kind {
        ...
        Function::Amordegrc => not_implemented(args),
        Function::Amorlinc => not_implemented(args),
        ...
        Function::Oddfprice => not_implemented(args),
        Function::Oddfyield => not_implemented(args),
        Function::Oddlprice => not_implemented(args),
        Function::Oddlyield => not_implemented(args),
        ...
        Function::Vdb => not_implemented(args),
