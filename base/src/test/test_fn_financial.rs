...
fn fn_received() {
    ...
    model._set("B1", "=RECEIVED(A2,A3,A4,A5,0)");

    model._set("C1", "=RECEIVED(A2,A3,A4)");
    model._set("C2", "=RECEIVED(A2,A3,A4,A5,5)");

    model.evaluate();

    assert_eq!(model._get_text("B1"), "989.795918367");
...
fn fn_coupdaysnc() {
    ...
    model._set("A1", "=COUPDAYSNC(DATE(2024,3,1),DATE(2026,7,1),2,0)");
    model._set("A2", "=COUPDAYSNC(DATE(2024,3,1),DATE(2026,7,1),2,1)");
    model._set("A3", "=COUPDAYSNC(DATE(2024,3,1),DATE(2026,7,1),2,3)");
    model._set("B1", "=COUPDAYSNC(DATE(2024,3,1),DATE(2026,7,1),3,0)");
    model._set("B2", "=COUPDAYSNC(DATE(2026,7,1),DATE(2024,3,1),2,0)");
    model._set("B3", "=COUPDAYSNC(DATE(2024,3,1),DATE(2026,7,1),2,5)");

    model.evaluate();

    assert_eq!(
        model.get_cell_value_by_ref("Sheet1!A1"),
        Ok(CellValue::Number(120.0))
    );
    assert_eq!(
        model.get_cell_value_by_ref("Sheet1!A2"),
        Ok(CellValue::Number(122.0))
    );
    assert_eq!(
        model.get_cell_value_by_ref("Sheet1!A3"),
        Ok(CellValue::Number(122.0))
...
fn fn_coupncd() {
    ...
    model._set("A1", "=COUPNCD(DATE(2024,3,1),DATE(2026,7,1),2,0)");
    model._set("A2", "=COUPNCD(DATE(2024,3,1),DATE(2026,7,1),2,1)");
    model._set("A3", "=COUPNCD(DATE(2024,3,1),DATE(2026,7,1),2,3)");
    model._set("B1", "=COUPNCD(DATE(2024,3,1),DATE(2026,7,1),3,0)");
    model._set("B2", "=COUPNCD(DATE(2026,7,1),DATE(2024,3,1),2,0)");
    model._set("B3", "=COUPNCD(DATE(2024,3,1),DATE(2026,7,1),2,5)");

    model.evaluate();

    assert_eq!(
        model.get_cell_value_by_ref("Sheet1!A1"),
        Ok(CellValue::Number(45474.0))
    );
    assert_eq!(
        model.get_cell_value_by_ref("Sheet1!A2"),
        Ok(CellValue::Number(45474.0))
...
fn fn_couppcd() {
    ...
    model._set("A1", "=COUPPCD(DATE(2024,3,1),DATE(2026,7,1),2,0)");
    model._set("A2", "=COUPPCD(DATE(2024,3,1),DATE(2026,7,1),2,1)");
    model._set("A3", "=COUPPCD(DATE(2024,3,1),DATE(2026,7,1),4,0)");
    model._set("B1", "=COUPPCD(DATE(2024,3,1),DATE(2026,7,1),3,0)");
    model._set("B2", "=COUPPCD(DATE(2026,7,1),DATE(2024,3,1),2,0)");
    model._set("B3", "=COUPPCD(DATE(2024,3,1),DATE(2026,7,1),2,5)");

    model.evaluate();

    assert_eq!(
        model.get_cell_value_by_ref("Sheet1!A1"),
        Ok(CellValue::Number(45292.0))
    );
    assert_eq!(
        model.get_cell_value_by_ref("Sheet1!A2"),
        Ok(CellValue::Number(45292.0))
